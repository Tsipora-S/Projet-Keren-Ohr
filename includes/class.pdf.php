...
$pdf->Cell(0.1, 25, 'Somme: ' . $montantCheque . ' euros');
$pdf->Cell(0.1, 35, 'Beneficiaire: ' . $nom . ' ' . $prenom);
$pdf->Cell(0.1, 45, 'Demeurant ' . $adresse . ' ' . $cp . ' ' . $ville);
$pdf->Cell(0.1, 54, 'Valable jusqu\'au ' . $dateValiditeCheque);
